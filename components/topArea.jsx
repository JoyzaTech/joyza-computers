...
export default function TopArea({ onCart }) {
    return(
        <div className="flex flex-cols p-4 items-center justify-center">
            ...
            <button className="bg-[#1D6ED7] hover:bg-[#005FA8] h-[2vw] p-2 m-2 rounded-full my-[1vw] flex items-center"><FaSearch className="bg-[#1D6ED7] hover:bg-[#005FA8] text-black"/></button>
            <input placeholder="Search..." className="bg-[#6E6E6E] text-white h-[4vh] my-[1vw] w-[30vw] rounded-xl pl-4"></input>
