...
export default function TopArea() {
    return(
        <div className="flex flex-cols p-4 items-center justify-center">
            ...
            <button className="bg-[#1D6ED7] h-[2vw] p-2 m-2 rounded-sm my-[1vw] flex items-center"><FaSearch className="bg-[#1D6ED7] text-black"/></button>
            <textarea placeholder="Search..." className="bg-[#6E6E6E] text-white h-[4vh] my-[1vw] w-[30vw]"></textarea>
            <button className="bg-[#0071C7] py-1 px-2 flex flex-row mx-2 rounded-lg">Cart <FaShoppingCart className="mx-4 my-1" /></button>
        </div>
    )
}